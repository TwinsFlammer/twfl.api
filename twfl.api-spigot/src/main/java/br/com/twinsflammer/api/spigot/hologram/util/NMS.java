package br.com.twinsflammer.api.spigot.hologram.util;
...
public class NMS {
    ...
    public static <T extends Entity> T spawnCustomEntity(Class<T> customEntityClass, Class<? extends Entity> entityClass, Location location) {
        try {
            ...
            customEntity.setLocation(location.getX(), location.getY(), location.getZ(), 0, 0);
            customEntity.setPositionRotation(location.getX(), location.getY(), location.getZ(), 0, 0);
    ...
    private static Field PATHFINDER_GOAL_1, PATHFINDER_GOAL_2;
