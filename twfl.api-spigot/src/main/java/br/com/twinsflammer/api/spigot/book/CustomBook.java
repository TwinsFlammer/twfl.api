package br.com.twinsflammer.api.spigot.book;

import br.com.twinsflammer.api.spigot.book.event.CustomBookOpenEvent;
import br.com.twinsflammer.api.spigot.book.util.Achievements;
import br.com.twinsflammer.api.spigot.book.util.NmsBookHelper;
...
public final class CustomBook {
    ...
    public static void openPlayer(Player player, ItemStack book) {
        CustomBookOpenEvent event = new CustomBookOpenEvent(player, book, false);
        ...
        //Opening the GUI
        NmsBookHelper.openBook(player, event.getBook(), event.getHand() == CustomBookOpenEvent.Hand.OFF_HAND);

        //Returning whatever was on itemInHand.
    ...
    public interface HoverAction {
        ...
        static HoverAction showAchievement(Achievement achievement) {
            return showAchievement(Achievements.toId(achievement));
        }
